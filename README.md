...
Transaction handling using class methods
...
Encapsulation — Protects account details like PIN and balance

Inheritance (optional, if extended)
...
Open the project file in an editor or terminal
